...
\begin{enumerate}
  ...
  A header in a single-story garage differs from a girder in a two-story bearing wall ($q_{\text{floor}} = 0$ vs.\ non-zero).
  ...
  These are modeled as random variables in the UQ framework.
\end{enumerate}
