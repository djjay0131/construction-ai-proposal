...
\begin{enumerate}
  ...
  \item \textbf{Engineered design dataset (planned).}
  Residential plan sets with stamped structural engineer-of-record designs are the target validation dataset.
  If such records can be obtained, the acceptance criterion will be that the stamped header size falls within the model-predicted feasible range for a majority of cases.
\end{enumerate}
