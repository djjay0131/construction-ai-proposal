...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig1_convergence_loglog}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig3_srq_convergence}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{fig2_local_error_N160}
...
\label{tab:coverage}
\begin{tabular}{>{\ttfamily}p{3.8cm}p{4.4cm}p{4.4cm}}
\toprule
...
exact\_simply\_supported()   & Used as reference benchmark & N/A (it is the reference) \\
BeamGeometry (I, S)          & Used for all SRQs & Non-rectangular sections \\
monte\_carlo\_assessment()   & \textbf{Not tested in HW3} & Entire MC loop untested \\
