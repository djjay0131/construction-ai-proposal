...
\midrule
$w_{\max}$ & $\displaystyle\frac{5\,q_0 L^4}{384\,\EI}$ & 0.05548021 & in \\[6pt]
...
\noindent
Test case: $L=96$\,in, $b=3.5$\,in, $d=11.25$\,in (double-ply 1.75-in wide LVL),
$E=2{,}000{,}000$\,psi (Weyerhaeuser 2.0E Microllam, ESR-1387),
$q_0=500$\,lb/ft\,$=41.67$\,lb/in.
Derived: $I=415.28$\,in$^4$, $S=73.83$\,in$^3$, $EI=8.306\times10^8$\,lb\,in$^2$.
...
\midrule
 10 & 9.6000 & $3.176\times10^{-3}$ & $4.438\times10^{-4}$ & --- & --- \\
 20 & 4.8000 & $7.940\times10^{-4}$ & $1.110\times10^{-4}$ & 2.000 & 2.000 \\
 40 & 2.4000 & $1.985\times10^{-4}$ & $2.774\times10^{-5}$ & 2.000 & 2.000 \\
 80 & 1.2000 & $4.962\times10^{-5}$ & $6.935\times10^{-6}$ & 2.000 & 2.000 \\
160 & 0.6000 & $1.241\times10^{-5}$ & $1.734\times10^{-6}$ & 2.000 & 2.000 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
$w_{\max}$ [in]      & 0.055480 & 0.055924 & 0.055482 & 0.0031\% \\
