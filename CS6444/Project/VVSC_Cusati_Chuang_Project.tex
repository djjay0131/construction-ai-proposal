...
The aleatory standard deviation $\sigma_E=160{,}000$~psi
(CoV~=~10\%) is supported by ASTM~D5456 acceptance limits for
structural composite lumber and the Grade-1 LVL CoV reported in
the NDS Supplement~\cite{nds2018}, so the $\alpha,\beta$ boundaries
correspond to physically realistic $\pm1\sigma$ excursions of the
modulus.
...
NDS-2018~\cite{nds2018} Grade-1 LVL allowable bending stress
$F_b\!\approx\!2{,}400$~psi (a stress-ratio of $0.32$).
