...
The aleatory standard deviation $\sigma_E=160{,}000$~psi (CoV~=~10\%)
...
grade with $E\!\approx\!1.6\times10^{6}$~psi, multiplied by the
D5457-bounded CoV of order 10\% as enforced through the D5456 QC chain---yields
the $\sigma_E=160{,}000$~psi used here.  The $\alpha,\beta$ boundaries
...
$U_{\rm MF}^+(600)=1.2\,d^+(500)=1.93\times10^{-3}$~in and
$U_{\rm MF}^-(600)=1.2\,d^-(500)=0.636\times10^{-3}$~in, which differ from
...
when $U_{\rm NUM}\!\ll\!U_{\rm MF}$ (here a factor of $\approx\!8\times$);
...
allowable bending stress for Microllam LVL at the residential header
grade ($F_b\!\approx\!2{,}400$~psi per the published design values in
ESR-1387~\cite{esr1387}, derived per the reliability-based methodology
of ASTM~D5457~\cite{astmD5457}), giving a stress-ratio of $0.32$.
The upper-95 deflection $w_{\rm max}^{\rm hi,95}=0.099$~in satisfies both
